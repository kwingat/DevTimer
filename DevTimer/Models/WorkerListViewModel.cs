...
{
    public class WorkerListViewModel : IHasCustomMapping
    {
        ...
        {
            configuration.CreateMap<Worker, WorkerListViewModel>()
                .IgnoreAllUnmapped()
                ...
                .ForMember(d => d.StateName, opt => opt.MapFrom(s => s.State.StateName))
            ...
            configuration.CreateMap<WorkerListViewModel, Worker>()
                .IgnoreAllUnmapped()
                .ForMember(d => d.ID, opt => opt.MapFrom(s => s.ID))
                .ForMember(d => d.Name, opt => opt.MapFrom(s => s.Name))
                .ForMember(d => d.Address1, opt => opt.MapFrom(s => s.Address1))
